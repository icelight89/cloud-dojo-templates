...
DOJO_SUBSCRIPTION_ID=ffd96b6f-1fcb-4bb8-b0ad-b151d795064a

# Set Dojo Subscription as default
az account set --subscription $DOJO_SUBSCRIPTION_ID
...
az rest --method put --headers "Content-Type=application/json" --uri "/subscriptions/$DOJO_SUBSCRIPTION_ID/resourceGroups/$RESOURCE_GROUP/providers/Microsoft.Web/staticSites/$STATIC_WEB_APP/config/functionappsettings?api-version=2019-12-01-preview" --body @local.settings.properties.json
